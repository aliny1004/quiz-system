// ===== 全域狀態：原始題庫、本次測驗、標記、計時器與持久化紀錄 =====
    ...
    function getQuizSettings() {
        return {
            ...
            wrongMode: document.getElementById('wrongModeCheckbox')?.checked || false,
            shuffleOptions: document.getElementById('shuffleOptionsCheckbox')?.checked || false,
            answerHint: document.getElementById('answerHintCheckbox')?.checked || false,
            hideTimer: document.getElementById('showTimerCheckbox')?.checked || false,
            questionScopeMode: document.getElementById('questionScopeMode')?.value || 'all',
            randomQuestionCount: parseInt(document.getElementById('randomQuestionCount')?.value, 10) || 0,
            rangeStartQuestion: parseInt(document.getElementById('rangeStartQuestion')?.value, 10) || 0,
            rangeEndQuestion: parseInt(document.getElementById('rangeEndQuestion')?.value, 10) || 0
        };
    }
